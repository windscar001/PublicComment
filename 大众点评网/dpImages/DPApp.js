(function () {
    ...
    window.DPApp = {
        ...
        ajax: function(opts) {
            ...
            DPApp.send_message('ajax', opts, function(json) {
                var errMsg = '';
                // console.log(json);
                if (json.code == 0) {
                    var rsp = null;
                    try {
                        ...
                        try {
                            ...
                            console.log('call success function error:', ignore);
                        }
                    } catch (e) {
        ...
        monitorScrollTop: function(pos, callback) {
            DPApp.send_message('monitorScrollTop', {pos: pos}, function (result) {
                callback(result.direction);
            });
        },
        loadImage: function(imageurl, callback) {
            DPApp.send_message('loadImage', {imageurl: imageurl}, function (result) {
                callback(result.img);
            });
        }
    };
